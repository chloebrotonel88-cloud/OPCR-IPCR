...
class WorkflowSettingsTest extends PmsTestCase
{
    ...
    {
        ['college' => $college, 'year' => $year, 'vp' => $vp] = $this->college();
    ...
    public function test_a_section_can_be_restored_to_the_default(): void
    {
        ...
        $settings->put('delegation', ['assign_outputs' => ['vp'], 'assign_indicators' => [], 'terminal_roles' => []]);
        $this->assertTrue($settings->mayAssignOutputs('vp'));
