    ...
    return (
        ...
        >
            <Typography.Paragraph type="secondary">
                Each person named below gets every ticked line in their own IPCR for this period,
                already tied back to this form. Anything they already hold is left alone.
                            ...
                            {group.outputs.map((output) => {
                                ...
                                return (
                                    <div key={output.id} style={{ margin: "8px 0 8px 4px" }}>
                                        ...
                                        >
                                            <Typography.Text strong>{output.title}</Typography.Text>
                                        </Checkbox>
