    ...
    SECTIONS.forEach((section) => {
        ...
        outputs.forEach((output, outputIndex) => {
            ...
            lines.forEach((line, lineIndex) => {
                ...
                const computed =
                    (line.children ?? []).length > 0 || Number(output.child_outputs_count ?? 0) > 0;
                        ...
                        <td>
                            <Space size={4} wrap>
                                {accountableFor(line).map((person) => (
                                    <span key={person.id} className="pms-person-chip">
                                        <span
                            ...
                            {delivery.people > 0 ? (
                                ...
                                !accomplishment?.actual_accomplishment && (
                                    <span className="pms-cell-empty">
                                        {Number(output.child_outputs_count ?? 0) > 0
            ...
            >
                <Typography.Paragraph type="secondary">
                    {assigning?.kind === "output"
                        ...
                        : "Each person gets this line in their own IPCR, seeded with its wording for them to reword."}
