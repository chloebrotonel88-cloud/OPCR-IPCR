...
const MENUS = {
    ...
    // My Forms is where the president writes the college OPCR; reviewing is QA's.
    president: [ITEMS.dashboard, ITEMS.collegeOpcr, ITEMS.myForms, ITEMS.reports],
    qa: [ITEMS.dashboard, ITEMS.rating, ITEMS.reports],
...
export default function AppLayout({ children }) {
    ...
    const selectedKey = useMemo(() => {
        ...
        // A form opened from a list still belongs to My Forms in the sidebar.
        if (!match && path.startsWith("/forms/")) return "/my-forms";
